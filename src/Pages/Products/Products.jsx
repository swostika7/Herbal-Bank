...
function Products() {
  return (
    ...
    <div className="p-5 mt-20 max-w-7xl mx-auto">
        <Heading heading={"All Products"} redesign={"text-primary text-center"}/>
      <div className="grid grid-cols-1 gap-4 container mx-auto md:grid-cols-2 lg:grid-cols-4 max-w-7xl">
        {Herbal.map((items, i) => (
          <ProductCard
            img={items.picture}
            title={items.title}
