...
<>
 <div className="bg-[url(/assets/back.png)] flex justify-center items-center relative  h-250 lg:h-204 md:h-300 w-full object-cover  ">
        ...
        <div className=" absolute flex flex-col justify-between items-center container max-w-7xl mx-auto md:flex-col lg:flex-row mb-40 lg:mb-0">
          <div className="space-y-6 mb-0  lg:mb-4 p-4  ">
            <h1 className="font-bold text-3xl md:text-5xl lg:text-5xl text-white leading-tight ">
              Muktinath Herbal Bank
              <span className="text-primary md:block lg:block"> for Natural Economy</span>
            </h1>

            <p className="text-white  lg:text-base max-w-3xl leading-4 md:leading-6 lg:leading-8
          ...
          <div className=" ">
            <img
              ...
              alt="Microscope"
              className="h-70 w-70 lg:h-130 lg:w-130 md:h-90 md:w-90 md:mb-30 "
            />
          </div>
        </div>
        {/* overlay  */}
