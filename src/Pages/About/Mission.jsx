...
function Mission() {
  return (
    <div className="bg-muted-foreground lg:p-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-3 p-5 container mx-auto max-w-7xl ">
        <Card
          icon={<LuLeaf size={30} className="text-primary" />}
          name={<p className="text-primary">Our Mission</p>}
          paragraph={
          ...
          cardDesign={"border-l-4 border-primary"}
        />
        <Card
          icon={<BiBullseye size={30} className="text-secondary" />}
          name={<p className="text-primary">Our Vision</p>}
          paragraph={
          ...
          cardDesign={"border-l-4 border-secondary"}
        />
      </div>
    </div>
  );
