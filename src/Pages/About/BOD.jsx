...
function BOD() {
  return (
    <div className="bg-muted-foreground h-full p-5 ">
      <div className="mx-auto max-w-7xl justify-center space-y-6">
        ...
        <div className="flex flex-col space-y-10  ">
          {Director.map((items, i) => (
            <div
              key={i}
              className=" flex flex-col justify-center md:flex-col lg:flex-row space-x-10 space-y-4 "
            >
              {/* image  */}
              ...
              <div className="col-span-2 max-w-7xl">
                <Heading
                  key={i}
                  heading={items.name}
